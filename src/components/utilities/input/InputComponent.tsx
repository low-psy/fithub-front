...
const InputComponent: React.FC<InputProps> = ({ className, ...rest }) => {
  let classProps;
  if (rest.type === 'text') {
    classProps = `${className} focus: mt-4 h-12 w-2/3 rounded-xl bg-input_bg px-4 text-xl text-slate-700 outline-none focus:outline-none focus:ring-2 focus:ring-main py-4`;
