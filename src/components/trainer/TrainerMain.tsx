...
const TrainerMain = () => {
  return (
    <section className="space-y-36 pb-24">
      <div className="flex flex-col items-center space-y-12 pt-48 text-5xl font-extrabold">
      ...
      <div className=" text-center">
        <div className="space-y-12">
          <h1 className="text-2xl font-bold text-accent">트레이닝 일정 관리</h1>
          <div>image</div>
